...
public class SecurityConfig {
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET,"/","/index","/presidents/**","/login","/register","/players/**","/teams/**", "/scss/**","/extra-images/**", "/css/**","/script/**","/images/**","/presidentImages/{id}","/playerImages/{id}","/teamImages/{id}", "favicon.icon").permitAll()
                .requestMatchers("/oauth2/**").authenticated()
                .requestMatchers(HttpMethod.POST,"/register","/login","/players/**").permitAll()
